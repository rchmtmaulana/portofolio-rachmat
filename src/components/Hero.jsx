                ...
                <div className="md:w-1/2 mt-10 md:mt-0 space-y-6 text-center md:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 pt-4">
                        <a
                            ...
                            download
                            className="px-8 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 shadow-lg hover:shadow-blue-500/30 transition transform hover:-translate-y-1"
                        >
                            Download CV
                        </a>
                        <div className="flex items-center gap-4">
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="p-3 bg-white text-slate-700 rounded-full shadow-md hover:text-blue-600 transition"
                            >
                                <FaGithub size={24} />
                            </a>
                            <a
